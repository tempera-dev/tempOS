...
| `model-route-decision.schema.json` | Metadata-only router decision response before prompt egress; compact journal evidence lives in `journal.schema.json` | §6.10, §13.4, §24 |
