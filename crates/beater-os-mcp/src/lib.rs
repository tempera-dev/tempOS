...
fn validate_server_config(config: &McpServerConfig) -> McpResult<()> {
    ...
    if config.max_request_bytes == 0
        || config.max_request_bytes > MAX_CONFIGURED_REQUEST_BYTES
    {
        ...
        "oneOf": [
            {
                ...
                "properties": {
                    ...
                    "admission_journal_root_hash": { "type": "string", "pattern": "^[0-9a-f]{64}$" },
                    "lease_seq": { "type": "integer", "minimum": 0 },
                    "lease_hash": { "type": "string", "pattern": "^[0-9a-f]{64}$" },
                    "tool_id": { "type": "string" },
                    "exit_code": { "type": ["integer", "null"] },
                    "stdout_digest": { "type": "string", "pattern": "^[0-9a-f]{64}$" },
                    "stdout_truncated": { "type": "boolean" },
                    "stderr_truncated": { "type": "boolean" },
                    "created": { "type": "array", "maxItems": MAX_ARTIFACT_PATHS, "items": { "type": "string" } },
                    "created_count": { "type": "integer", "minimum": 0 },
                    "created_truncated": { "type": "boolean" },
                    "modified": { "type": "array", "maxItems": MAX_ARTIFACT_PATHS, "items": { "type": "string" } },
                    "modified_count": { "type": "integer", "minimum": 0 },
                    "modified_truncated": { "type": "boolean" },
                    "deleted": { "type": "array", "maxItems": MAX_ARTIFACT_PATHS, "items": { "type": "string" } },
                    ...
                    "receipt_journal_hash": { "type": "string", "pattern": "^[0-9a-f]{64}$" },
                    "receipt_seq": { "type": "integer", "minimum": 0 },
                    "receipt_root_hash": { "type": "string", "pattern": "^[0-9a-f]{64}$" },
                    "final_journal_root_hash": { "type": "string", "pattern": "^[0-9a-f]{64}$" },
                    "receipts": { "type": "integer", "minimum": 0 },
                    "runnable_pending_actions": { "type": "integer", "minimum": 0 },
